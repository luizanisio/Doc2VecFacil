...
- Opcionamente pode-se criar quantos dicionários quiser com o prefixo `vocab_base*.txt`, os termos desses dicionários <b>não</b> farão parte do dicionário principal criado, nem farão parte do complementar, pois entende-se que já estão fixados para treinamento e vão compor o vocabulário final de treinamento. 
